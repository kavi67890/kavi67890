...
<div align="center">
 ...
 <!--[GitHub Snake Dark](https://github.com/Kaviyarasu-M01/Kaviyarasu-M01/blob/main/.github/workflows/github-contribution-grid-snake.svg#gh-dark-mode-only)-->
...
- Protein Structure Prediction Support
- Drug-Target Interaction Modelling
- Genomics & Proteomics Pipelines
- PubChem / ChEMBL Data Mining
...
![Backtrader](https://img.shields.io/badge/Backtrader-FF4B4B?style=for-the-badge&logo=python&logoColor=white)
![Bloomberg API](https://img.shields.io/badge/Bloomberg_API-000000?style=for-the-badge&logo=bloomberg&logoColor=orange)

### Bioinformatics Stack
![RDKit](https://img.shields.io/badge/RDKit-3E9F3C?style=for-the-badge&logo=python&logoColor=white)
![Biopython](https://img.shields.io/badge/Biopython-1E90FF?style=for-the-badge&logo=python&logoColor=white)
![DeepChem](https://img.shields.io/badge/DeepChem-7B2FBE?style=for-the-badge&logo=python&logoColor=white)
...
### 💹 QuantSense — Algorithmic Trading Engine
> ML-powered stock signal generator with LSTM-based price forecasting and backtesting framework.
...
### 🧬 BioML — Drug-Target Interaction Predictor
> Graph Neural Network model predicting molecular binding affinity using ChEMBL dataset.
...
### 📉 CreditRisk-ML — Credit Default Prediction
> End-to-end ML pipeline for credit risk scoring with SHAP explainability dashboard.
...
### 🔬 ProteinLM — Protein Function Classifier
> Fine-tuned ESM-2 transformer model for protein family classification on UniProt sequences.
...
```
🔭 Exploring  →  Reinforcement Learning for Quantitative Finance
🧬 Researching →  Multi-Modal Models for Drug Discovery (Vision + NLP)
📖 Reading     →  "Advances in Financial Machine Learning" — Marcos López de Prado
⚙️ Building    →  Real-time options pricing engine with Monte Carlo simulation
🤝 Open to     →  Collaboration on Finance ML or Bioinformatics projects
```
...
> *"The intersection of biology, finance, and data science is where the next great discoveries will happen."*
>
...
<a href="mailto:kaviyarasu1204@gmail.com">
  <img src="https://img.shields.io/badge/📧 Email-Say Hello-D14836?style=for-the-badge"/>
</a>
...
<sub>⭐ Star repos you find interesting • 🍴 Fork what you find useful • 🤝 PRs are always welcome</sub>
